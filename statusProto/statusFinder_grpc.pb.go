...
type StatusServiceClient interface {
	Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusList, error)
}
...
func (c *statusServiceClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusList, error) {
	out := new(StatusList)
	err := c.cc.Invoke(ctx, "/statusProto.statusService/Status", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServiceServer interface {
	Status(context.Context, *StatusRequest) (*StatusList, error)
...
func (UnimplementedStatusServiceServer) Status(context.Context, *StatusRequest) (*StatusList, error) {
...
func _StatusService_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/statusProto.statusService/Status",
	}
...
var StatusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "statusProto.statusService",
	...
	Metadata: "statusProto/statusFinder.proto",
}
